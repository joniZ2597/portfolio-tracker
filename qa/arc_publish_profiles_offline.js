...
if (lib) {
  ...
  if (library) {
    ...
    check('EP-B0 library has the eleven canonical profiles', Object.keys(library.profiles).sort().join(',') === 'COWORK-REGISTER,LAB-CODE-SLICE,LAB-SANDBOX-STATIC,MAIN-BROWSER-QA,MAIN-CODE-SLICE,MAIN-CODE-SLICE-BOUNDED,MAIN-GATED-LIVE-QA,MAIN-PROFILE-SLICE,MAIN-SKILL-AUTHORING,MAIN-SKILL-SLICE,OWNER-MANUAL');
