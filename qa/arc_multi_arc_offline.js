...
const REL = {
  ...
  forbidden: [
    ...
    '.claude/skills/arc-progress-auditor/SKILL.md', '.claude/skills/arc-progress-auditor/references/scan-contract.md', '.claude/skills/arc-progress-auditor/templates/arc-audit.md',
    'netlify.toml'
  ]
};
